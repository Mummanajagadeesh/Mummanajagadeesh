# Witaj świecie! This is [Jagadeesh](https://mummanajagadeesh.github.io/). <!-- updated: 2025-08-15 00:18:16 IST -->
...
- **Developed a `lightweight CNN [Conv2D×2 + MaxPool]×3 → GAP → Dense(10)` for `CIFAR-10 Image Classification (32x32RGB)` using both `IEEE 754` floating-point and `Q1.31` and `Q1.15` fixed-point arithmetic, achieving 84% accuracy in both implementations (FP \~84% | Q31 \~84% | Q15 \~84% | Q7 \~82%)**
